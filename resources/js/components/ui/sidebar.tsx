    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full bg-brand-gradient",
            "has-data-[variant=inset]:bg-brand-gradient",
            className
          )}
          {...props}
        >
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "brand-glass flex h-full w-(--sidebar-width) flex-col",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="brand-glass w-(--sidebar-width) p-0 text-white [&>button]:hidden"
          style={
            {
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-brand-gradient relative flex max-w-full min-h-svh flex-1 flex-col",
